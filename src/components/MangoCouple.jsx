...
const LINES = {
  ...
  melang: {
    ...
    coffee: ['오예 커피☕', '물적게 얼음많이☕','낑꽁깡','커피 고마웡', '짱!', '라뷰 커피', '물적게 얼음 많이! 땡큐', '야호', '강아지는 커피먹으면 안대','커피는 역시 강아지가 사주는거','카페인 충전 완료','아아가 최고야','한모금 남겨준거야? 감동','아 살거같다','메이슨도 커피마셔요?','메이슨 커피 감사해요','메이슨 이따 커피 한잔 하실래요?'],
    ...
    snack: ['냠냠! 🥟','냠냠냐냐ㅑ냠', '개마싯다', '얌얌','마싯따','2차?','다음엔 뭐먹을까?','강아지는 지금 배 얼마나 찼어?','다음엔 뭐먹을래?', '2차 고?','하나 더 줘','강아지 고마워','강아지는 배 얼마나불러?','강아지가 주는 만두 짱','하이디라오 먹으러갈래?','앙~ 하나만 더','배불렁','겸이가 주는 만두가 세상에서 제일 최고','만두볼 됐다 나','메이슨도 이거 드셔보실래요?','메이슨 이 집 만두 잘하네요','메이슨 점심 뭐 드셨어요?'],
    tap: ['간지렁', '그만 만졋', '어맛?','어마맛','만지지맛', '알라뷰우','알라뷰','간지럿','꺄','꺄아','앙대 간지럽다구','한번만 더 만지면 문다','히히 좋아','뀨우','우리 강아지 왜케 이쁘지~?','우리 강아지 왜케 잘생겼지?'],
