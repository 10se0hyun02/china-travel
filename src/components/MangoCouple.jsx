...
const LINES = {
  mango: {
    love: ['라뷰 💕', '사랑해', '알라뷰', '뽀뽀해줘 💋','낑', '꽁','깡','낑꽁깡','공주 사랑해','내가 더 사랑하는데~?','심장 발싸','공주밖에 없어','평생 붙어있을거야','뀽'],
  ...
  melang: {
    love: ['라뷰 강아지🐶', '나도 사랑해', '낑', '꽁','깡','낑꽁깡','강아지 사랑해','우리강아지 최고','최고미남 김민겸','겸아 라뷰','내 강아지 평생 해','뀨','김민겸 사랑이 최고지'],
    coffee: ['오예 커피☕', '커피 고마웡', '짱!', '라뷰 커피', '물적게 얼음 많이? 땡큐', '야호', '강아지는 커피먹으면 안대','커피는 역시 강아지가 사주는거','카페인 충전 완료','아아가 최고야','한모금 남겨준거야? 감동','메이슨도 커피마셔요?','메이슨 커피 감사해요','메이슨은 아아파예요?','메이슨 이따 커피 한잔 하실래요?'],
    fan: ['살거같다 🍃', '으앙 개더워', '한번 더 (짝)', '멜팅 멜랑💦','상해 진짜 개덥따','시원행 고마웡','나 날아가겠엉','강아지 짱','나 이거 평생 해줘 사랑해','나 머리 말려줭','메이슨 여기 자리 시원해요','메이슨도 좀 쐬실래요?'],
    snack: ['냠냠! 🥟', '개마싯다', '얌얌', '하나 더 줘','강아지 고마워','강아지가 주는 만두 짱','앙~ 하나만 더','배불렁','겸이가 주는 만두가 세상에서 제일 최고','만두볼 됐다 나','메이슨도 이거 드셔보실래요?','메이슨 이 집 만두 잘하네요','메이슨 점심 뭐 드셨어요?'],
  ...
  return (
    <div>
      ...
      <div className="relative flex items-end justify-center">
        ...
        {/* 맞잡은 손 사이 하트 */}
        <span className="mb-9 -mx-2 text-base shrink-0 animate-pulse z-10">❤️</span>
