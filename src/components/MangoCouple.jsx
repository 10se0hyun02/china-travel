...
const STORAGE_KEY = 'mango-care-v5'; // v4 -> v5: 애정도 리셋 목적으로 키 버전만 올림 (이전 데이터는 자연히 무시됨)
const MAX_LEVEL = 15;
const PRESSES_PER_LEVEL = 200; // 캐릭터별 200회마다 레벨 +1, 각자 3000회에 만렙
...
const LINES = {
  mango: {
    love: ['라뷰 💕','라뷰 공주', '사랑해', '알라뷰', '뽀뽀해줘 💋','낑', '꽁','깡','낑꽁깡','공주 사랑해','내가 더 사랑하는데~?','심장 발싸','공주밖에 없어','평생 붙어있을거야','뀽','뀨','끼잉','공주 없인 못살아','안아줘도돼?','뽀뽀 한번 더','공주 얼굴 보니까 좋다','계속 옆에 있고싶어','손 놓기 싫어','공주가 세상에서 제일 예뻐','매일 더 좋아져','공주 웃는거 완전 좋아','심쿵사할뻔','공주야 사랑해','자기야 사랑해','오늘도 사랑해','진짜 많이 사랑해'],
    coffee: ['와 시원해 ☕', '맛있따', '근데 공주 나 배아포', '커피 먹으니까 약간 속이 이상해','맛있다 커피','수박주스 먹고싶다','델라 저랑 스타벅스 가실래요?','공주가 사주는 커피가 젤 맛있어','한모금만 더 줘','아아 최고얌','커피 마시고 힘내서 걸을게!','카페인보다 공주가 더 좋아','오늘 커피 진짜 맛있다','공주 취향 저격 커피네','한잔 더 마셔도돼?','커피 사줘서 고마워 진짜','이거 다 마시고 손잡자','공주랑 마시는 커피가 제일 맛있어','든든하다 이제 걸을수있어','공주야 사랑해','자기야 사랑해','오늘도 사랑해','진짜 많이 사랑해'],
    fan: ['으앙 시원해🍃', '나 땀으루 쫄딱 다젖었어', '땀나', '개더웡 💦','손풍기 사주는여자 처음이야','바람 나만 쐬도돼~?','시원행 헤헤','공주도 시원해야대','잎사귀 날아가겟어','이 바람 진짜 천국이야','공주 최고의 발명품','더워죽는줄','시원한거 최고','땀 식는다 진짜','공주가 살려줬어','더위 싹 가셨어','부채질도 해줄까?','공주야 사랑해','자기야 사랑해','오늘도 사랑해','진짜 많이 사랑해'],
    snack: ['와 이거 진짜맛있다 🥟', '나 다먹을 수 있어!', '다먹는거 쉽지', '다 먹어도돼?','나 만두 진짜 50개 먹을 수 있어','만두는 비비고가 짱이다진짜','공주도 한입 아~','배 터질때까지 먹을래','육즙 팡','진짜 맛있따','나 배 80%찼어', '진짜 배불러 진짜야','이 만두 진짜 인생만두야','한입 더 먹어도돼?','배터지기 직전이야','존맛탱','만두 왕이 됐어','다음 여행도 만두먹으러 오자','진짜 이집 만두 미쳤다','공주도 얼른 먹어봐','공주야 사랑해','자기야 사랑해','오늘도 사랑해','진짜 많이 사랑해'],
  ...
  melang: {
    love: ['나두 사랑해!!','나두 사랑해','라뷰 강아지🐶', '라뷰','냐옹!','우리 낑강아지 사랑해','겸아 라뷰','나도 사랑해', '낑', '꽁','깡','낑꽁깡','강아지 사랑해','우리강아지 최고','최고미남 김민겸','김민겸 사랑해','사랑해 민겸아','강아지 최고 사랑해','똑똑이 강아지 사랑해','우리 똑똑잉 사랑해','겸아 라뷰','내 강아지 평생 해','뀨','김민겸이 최고','평생 사랑해','우리강아지 짱','강아지 사랑해','라뷰 라뷰','겸아 라뷰','김메이슨 사랑햇','알랴뷰','사랑해','사랑해 진~짜 많이','강아지 없인 못살아','나도 안아줘','뽀뽀 한번 더 해줘','강아지 얼굴 보면 힐링됨','계속 붙어있고싶어','강아지가 세상에서 제일 잘생겼어','매일 더 좋아지는중','강아지 웃는거 개좋아','심쿵사 직전','평생 옆에 있어줘','자기야 사랑해','겸아 사랑해','오늘도 사랑해','진짜 많이 사랑해'],
    coffee: ['츄릅','오예 커피☕', '물적게 얼음많이☕','낑꽁깡','커피 고마웡', '짱!', '라뷰 커피', '물적게 얼음 많이! 땡큐', '야호', '강아지는 커피먹으면 안대','커피는 역시 강아지가 사주는거','카페인 충전 완료','아아가 최고야','한모금 남겨준거야? 감동','아 살거같다','메이슨도 커피마셔요?','메이슨 커피 감사해요','메이슨 이따 커피 한잔 하실래요?','오늘 커피 완전 내 취향','한잔 더 사줘도돼?','강아지가 사준 커피는 다 맛있어','카페인 충전 완료 고마워','든든하다 힘내서 걷자','다음에도 이 카페 오자','강아지랑 마시는 커피가 제일 맛있어','자기야 사랑해','겸아 사랑해','오늘도 사랑해','진짜 많이 사랑해'],
    fan: ['살거같다 🍃','낑','낑꽁깡','윙윙', '강아지두 덥지?','와 시원','와 시원해' , '으앙 개더워', '한번 더 (짝)', '멜팅 멜랑💦','상해 진짜 개덥따','시원행 고마웡','나 날아가겠엉','강아지 짱','나 이거 평생 해줘 사랑해','나 머리 말려줭','메이슨 여기 자리 시원해요','메이슨도 좀 쐬실래요?','이 바람 천국이다','강아지 최고의 발명품','더위 싹 가셨어','시원한거 최고','땀 다 식었어','강아지가 살려줬어','부채질도 해줘','더워죽는줄 알았어','자기야 사랑해','겸아 사랑해','오늘도 사랑해','진짜 많이 사랑해'],
    snack: ['냠냠! 🥟','냠냠냐냐ㅑ냠', '개마싯다', '얌얌','짭짭슨','짭짭슨 메이슨','마싯따','2차?','다음엔 뭐먹을까?','강아지는 지금 배 얼마나 찼어?','다음엔 뭐먹을래?', '2차 고?','하나 더 줘','강아지 고마워','강아지는 배 얼마나불러?','강아지가 주는 만두 짱','하이디라오 먹으러갈래?','앙~ 하나만 더','배불렁','겸이가 주는 만두가 세상에서 제일 최고','만두볼 됐다 나','메이슨도 이거 드셔보실래요?','메이슨 이 집 만두 잘하네요','메이슨 점심 뭐 드셨어요?','이 만두 인생만두야','한입 더 줘봐','배불러 죽겠어','존맛','만두 여왕 등극','다음 여행도 만두 먹으러 오자','이집 만두 미쳤다','강아지도 얼른 먹어봐','자기야 사랑해','겸아 사랑해','오늘도 사랑해','진짜 많이 사랑해'],
