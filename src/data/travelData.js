export const travelData = {
  ...
  , spots: {
    "pudong_airport": {
      ...
      , detail: {
        subtitle: "푸동공항 도착 후 실전 팁"
        , sections: [
          {
            heading: "택시 타는 곳"
            , lines: [
              "입국장 나와서 수화물 수취 → 세관 통과 후, 터미널1은 12번 출구, 터미널2는 25번 출구로 나가면 공식 택시 승강장이에요."
              , "나오자마자 '택시 싸게 해줄게' 하는 호객꾼들이 붙는데 절대 따라가지 말고 'Taxi' 표지판 따라 정식 줄에서 타세요."
              , "시내(인민광장 기준)까지 약 200위안, 30~40분 소요(정체 시 더 걸림)."
            ]
          }
          , {
            heading: "디디(DiDi) 추천"
            , lines: [
              "정찰제라 바가지 걱정 없어서 택시보다 디디를 더 추천해요. 알리페이 등록해서 앱 안에서 부르면 됨."
              , "도착 이틀 전쯤 공항픽업 예약도 가능하니, 짐 많고 피곤한 첫날엔 미리 예약해두면 편해요."
              , "유심/이심은 도착 전에 준비해두세요 (디디 부르려면 데이터 필요)."
            ]
          }
        ]
      }
